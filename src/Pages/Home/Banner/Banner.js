            ...
            <Carousel fade>
                <Carousel.Item>
                    <img
                        ...
                        src="./images/car-services/car-service-2.jpg"
                        alt="First slide"
                    />
                    <Carousel.Caption>
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-3.jpg"
                        alt="Second slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-4.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-5.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-6.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-7.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-8.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-9.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-10.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-11.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-12.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-13.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-14.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-15.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-16.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-17.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-18.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-19.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-20.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-21.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-22.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-23.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-24.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-25.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-26.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-27.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-28.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-29.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-30.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-31.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-32.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-33.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-34.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-35.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-36.jpg"
                        alt="Third slide"
                    />
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-100"
                        src="./images/car-services/car-service-37.jpg"
                        alt="Third slide"
                    />
